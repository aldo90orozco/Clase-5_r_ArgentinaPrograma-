...
const $botonIngresar=document.querySelector("#enviarDatos");
//dame el elemento enviar datos $indica que es elemento de html
function calcularSalarioMensual(salarioAnual){
  return salarioAnual/12;
}
$botonIngresar.onclick= function(){//funcion anonima
